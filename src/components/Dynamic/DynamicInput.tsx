...
export default function DynamicInput<T extends FieldValues>(props: Props<T>) {
  return (
    <div className="form-control w-full max-w-screen-sm">
      ...
      <input
        id={props.field_id}
        {...props.register(props.field_id,{valueAsNumber: props.type==='number'? true:false})}
        placeholder={props.placeholder}
        className="input-bordered input w-full bg-slate-50 sm:input-sm md:input-md placeholder:text-xs"
        type={props.type}
      />
